...
def r2h(input_string):
    ...
    word_list = re.findall(r'(ky[auo]|gy[auo]|sh[auo]|j[auo]|ch[iauo]|jy[auo]|ny[auo]|hy[auo]|by[auo]|py[auo]|my[auo]|ry[auo]|shi|tsu|tu|sakuon|[kgztdnhbpmyrwvsj][aiueot]|[aiueon~.!?,-~0123456789)(]|[kgyshjcdtbnmry][yaoue]{2,3})', input_string)
